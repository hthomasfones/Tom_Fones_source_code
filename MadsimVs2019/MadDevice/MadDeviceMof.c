//
// MadDeviceMof.c - Code generated by wmimofck tool
//
...
NTSTATUS
MadDeviceMofInitializeWmilibContext(
    IN PWMILIB_CONTEXT WmilibContext
    );

NTSTATUS
MadDeviceMofFunctionControl(
...
#ifdef ALLOC_PRAGMA
#pragma alloc_text(PAGE,MadDeviceMofQueryWmiRegInfo)
#pragma alloc_text(PAGE,MadDeviceMofQueryWmiDataBlock)
#pragma alloc_text(PAGE,MadDeviceMofSetWmiDataBlock)
#pragma alloc_text(PAGE,MadDeviceMofSetWmiDataItem)
#pragma alloc_text(PAGE,MadDeviceMofExecuteWmiMethod)
#pragma alloc_text(PAGE,MadDeviceMofFunctionControl)
#pragma alloc_text(PAGE,MadDeviceMofInitializeWmilibContext)
#endif
...
UCHAR MadDeviceMofBinaryMofData[] =
{
    #include "MadDeviceMof.x"
};
#ifdef ALLOC_DATA_PRAGMA
   #pragma data_seg()
#endif
...
#define MadDevWmiInfoGuidIndex    0
#define MadDeviceNotifyDeviceArrivalGuidIndex    1
#define MadDevWmiControlGuidIndex    2
#ifdef USE_BINARY_MOF_QUERY
#define BinaryMofGuidIndex   3
#endif
//
// List of guids supported

GUID MadDevWmiInfoGUID = MadDevWmiInfoGuid;
GUID MadDeviceNotifyDeviceArrivalGUID = MadDeviceNotifyDeviceArrivalGuid;
GUID MadDevWmiControlGUID = MadDevWmiControlGuid;
#ifdef USE_BINARY_MOF_QUERY
GUID MadDeviceMofBinaryMofGUID =         BINARY_MOF_GUID;
#endif

//
// TODO: Make sure the instance count and flags are set properly for each
//       guid
WMIGUIDREGINFO MadDeviceMofGuidList[] =
{
    {
        &MadDevWmiInfoGUID,                        // Guid
        1,                               // # of instances in each device
        0                                // Flags
    },
    {
        &MadDeviceNotifyDeviceArrivalGUID,                        // Guid
        1,                               // # of instances in each device
        0                                // Flags
    },
    {
        &MadDevWmiControlGUID,                        // Guid
        1,                               // # of instances in each device
        0                                // Flags
    },
#ifdef USE_BINARY_MOF_QUERY
    {
        &MadDeviceMofBinaryMofGUID,
        1,
        0
    }
#endif
...
#define MadDeviceMofGuidCount (sizeof(MadDeviceMofGuidList) / sizeof(WMIGUIDREGINFO))
...
// of it into MadDeviceMofRegistryPath in the DriverEntry routine
//
extern UNICODE_STRING MadDeviceMofRegistryPath;

NTSTATUS MadDeviceMofSystemControl(
...
--*/
{
    ...
    // your driver.
    *RegistryPath = &MadDeviceMofRegistryPath;
...
--*/
{
    ...
    switch(GuidIndex)
    {
        ...
        case MadDeviceNotifyDeviceArrivalGuidIndex:
        {
            //
            // TODO: Check that the size of the buffer passed is large enough
            //       for all of the instances requested and if so fill Buffer
        ...
        case MadDevWmiControlGuidIndex:
        {
            //
            // TODO: Check that the size of the buffer passed is large enough
            //       for all of the instances requested and if so fill Buffer
        ...
        case BinaryMofGuidIndex:
        {
            ...
            //
            sizeNeeded = sizeof(MadDeviceMofBinaryMofData);

            if (BufferAvail < sizeNeeded)
            {
                status = STATUS_BUFFER_TOO_SMALL;
            } else {
                RtlCopyMemory(Buffer, MadDeviceMofBinaryMofData, sizeNeeded);
...
--*/
{
    ...
    WmilibContext->GuidCount = MadDeviceMofGuidCount;
    WmilibContext->GuidList = MadDeviceMofGuidList;    
    
    WmilibContext->QueryWmiRegInfo = MadDeviceMofQueryWmiRegInfo;
    WmilibContext->QueryWmiDataBlock = MadDeviceMofQueryWmiDataBlock;
    WmilibContext->SetWmiDataBlock = MadDeviceMofSetWmiDataBlock;
    WmilibContext->SetWmiDataItem = MadDeviceMofSetWmiDataItem;
    WmilibContext->ExecuteWmiMethod = MadDeviceMofExecuteWmiMethod;
    WmilibContext->WmiFunctionControl = MadDeviceMofFunctionControl;

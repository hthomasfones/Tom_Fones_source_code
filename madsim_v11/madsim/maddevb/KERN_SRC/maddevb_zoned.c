...
static inline unsigned int maddevb_zone_no(struct maddevblk_device *dev, sector_t sect)
{
...
{
	struct maddevb *maddevb = disk->private_data;
	struct maddevblk_device *dev = maddevb->dev;

...
#define MADDEVOBJ_IOC_LOAD_READ_CACHE    _IOR(MADDEVOBJ_IOC_MAGIC, MADDEVOBJ_IOC_INDEX_BASE+9, void*)
#define MADDEVOBJ_IOC_FLUSH_WRITE_CACHE  _IOW(MADDEVOBJ_IOC_MAGIC, MADDEVOBJ_IOC_INDEX_BASE+10, void*)
//

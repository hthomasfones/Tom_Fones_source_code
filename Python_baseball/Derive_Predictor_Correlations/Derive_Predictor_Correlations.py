...
print("Derived_Predictor_Correlations_predictors: hometeam_win relative_payroll relative_record team_history team_momentum",\
      HOMETEAM_WIN_PRED_RATE, RLTV_PAYROLL_PRED_RATE, RLTV_RECORD_PRED_RATE,\
      TEAM_HISTORY_PRED_RATE, TEAM_MOMENTUM_PRED_RATE)

print("Derived_Predictor_Correlations predictors: rates_sum min max:",

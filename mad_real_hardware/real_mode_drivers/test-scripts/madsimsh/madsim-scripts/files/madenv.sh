...
###busdrvrpath="/lib/modules/5.15.124-yocto-standard/extra/"
busdrvrpath="/lib/modules/$(uname -r)/extra/"
busmodule="madbus"
busdevobj="madbusobj"
busdevname="madbus_0"
#

...
//This function implements a simulation of the equivalent pci function
void /*int*/ pcisim_disable_device(struct pci_dev* pPcidev);
void /*int*/ pcisim_disable_device(struct pci_dev* pPcidev)
{
...
int madbus_init_pci_config(PMADBUSOBJ pmadbusobj, bool bMSI)
{
    ...
    u64 bar0 = (u64)pmadbusobj->MadDevPA; //device physical address
    u64 bar2 = (u64)pmadbusobj->MadDevPA + MAD_BAR0_APERTURE_SIZE; 
    u64 bar4 = (u64)pmadbusobj->MadDevPA + MAD_MAPD_READ_OFFSET; //cache data
